...
<x-admin-layout :breadcrumbs="[
    ...
    <div class="max-w-4xl mx-auto">
        ...
        {{-- Encabezado --}}
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Crear Nuevo Servicio</h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Completa la información para agregar un servicio al catálogo del sitio web.</p>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6">
                ...
                <div>
                    ...
                    <div>
                        ...
                        {{-- Preview area con drag & drop visual --}}
                        <div class="relative">
                            <input type="file"
                                   id="image"
                                   name="image"
                            ...
                            <label for="image"
                                   id="dropArea"
                                   class="flex flex-col items-center justify-center w-full h-48 bg-gray-50 dark:bg-gray-700 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:border-indigo-400 dark:hover:border-indigo-500 transition-colors">
                    ...
                    <div class="mt-6">
                        <label class="inline-flex items-center gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400">Se mostrará con borde dorado en el sitio web (ideal para paquetes especiales).</p>
                            </div>
                        </label>
                    </div>
                </div>
